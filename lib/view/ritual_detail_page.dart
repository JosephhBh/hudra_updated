...
class RitualDetailsPage extends StatefulWidget {
  const RitualDetailsPage({
    super.key,
  ...
  @override
  State<RitualDetailsPage> createState() => _RitualDetailsPageState();
}

class _RitualDetailsPageState extends State<RitualDetailsPage> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    var bibleData = jsonDecode(widget.ritualObject.itemDesc);
