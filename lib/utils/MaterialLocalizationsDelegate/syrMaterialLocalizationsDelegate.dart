...
//
// /// A custom set of date patterns for the `syr` locale.
// ///
...
// };
//
// /// A custom set of date symbols for the `syr` locale.
// ///
...
//
// // #docregion Delegate
// class _SyrMaterialLocalizationsDelegate
//     extends LocalizationsDelegate<MaterialLocalizations> {
//   const _SyrMaterialLocalizationsDelegate();
//
//   @override
//   bool isSupported(Locale locale) => locale.languageCode == 'syr';
//
//   @override
//   Future<MaterialLocalizations> load(Locale locale) async {
//     final String localeName = intl.Intl.canonicalizedLocale(locale.toString());
//
//     // The locale (in this case `syr`) needs to be initialized into the custom
//     // date symbols and patterns setup that Flutter uses.
//     date_symbol_data_custom.initializeDateFormattingCustom(
//       locale: localeName,
//       patterns: syrLocaleDatePatterns,
//       symbols: intl.DateSymbols.deserializeFromMap(syrDateSymbols),
//     );
//
//     return SynchronousFuture<MaterialLocalizations>(
//       syrMaterialLocalizations(
...
//
//   @override
//   bool shouldReload(_SyrMaterialLocalizationsDelegate old) => false;
// }
// // #enddocregion Delegate
//
// /// A custom set of localizations for the 'syr' locale. In this example, only
// /// the value for openAppDrawerTooltip was modified to use a custom message as
// /// an example. Everything else uses the American English (en_US) messages
// /// and formatting.
// class syrMaterialLocalizations extends GlobalMaterialLocalizations {
//   const syrMaterialLocalizations({
//     super.localeName = 'syr',
...
//   _SyrMaterialLocalizationsDelegate();
//
//   @override
